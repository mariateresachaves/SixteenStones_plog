...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.3]{first_move.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.3]{push_3_stones.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.3]{invalid_push.png} 
	\caption{\textit{Push} inválido por realizar um \textit{Push}: nas suas próprias pedras(a); numa célula vazia (b).}
\end{figure}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.2]{valid_invalid_move.png} 
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.3]{move_cap.png} 
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.3]{move_no_cap.png} 
...
\begin{figure}[!htb]
	...
	\caption{Jogador azul realiza um \textit{Move}, um \textit{Sacrifice} e depois um \textit{Push} e ganha o jogo.}
\end{figure}
